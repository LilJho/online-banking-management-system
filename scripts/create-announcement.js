...
const modal = document.getElementById("create-announcement");
        ...
        // const updateButton = document.getElementById("create-announcement-btn");
        // Get the <span> element that closes the modal
        const closeUpdateButton = document.getElementById("close-edit-announcement-button");
        ...
        // When the user clicks on <span> (x), close the modal
        closeUpdateButton.onclick = function() {
        ...
        document.querySelector('.edit-announcement-form').addEventListener('submit', async function (event) {
            event.preventDefault(); // Prevent default form submission behavior
        
            const titleInput = document.getElementById('edit-announcement-title');
            const descriptionInput = document.getElementById('edit-announcement-description');
            const modal = document.getElementById("update-announcement");
            ...
            if (!description || !title || !id) {
                console.error('Description or title or id is missing.');
                return;
            }
            ...
            formData.append('new-description', description);
            formData.append('id', id);

            try {
                const response = await fetch('/update-announcement.php', {
                    method: 'POST',
                    body: formData,
                });
