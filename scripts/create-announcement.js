...
// const updateButton = document.getElementById("create-announcement-btn");
// Get the <span> element that closes the modal
const closeUpdateButton = document.getElementById(
  "close-edit-announcement-button"
);
...
document
  .querySelector(".create-announcement-form")
...
document
  .querySelector(".edit-announcement-form")
  .addEventListener("submit", async function (event) {
    event.preventDefault(); // Prevent default form submission behavior
